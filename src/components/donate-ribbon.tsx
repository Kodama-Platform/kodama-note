      ...
      <div className="note-card !p-3 shadow-card">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-xs text-foreground">
            <p className="font-display text-sm font-light">Kodama is free and ad-free.</p>
            ...
            <div className="mt-2 flex items-center gap-2">
              <a
                ...
                onClick={dismiss}
                className="btn-moss !h-8 !px-3 !py-0 !text-[11px]"
              >
                Support Kodama
              </a>
              <button
                onClick={dismiss}
                className="note-toolbar-btn !h-8 !border-transparent !bg-transparent !text-[11px] text-muted-foreground"
              >
                Not now
              </button>
            </div>
          ...
          <button
            onClick={dismiss}
            aria-label="Dismiss"
            className="note-toolbar-btn !h-8 !w-8 !border-transparent !bg-transparent !px-0 text-muted-foreground"
          >
